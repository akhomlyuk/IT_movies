...
- `index.html` — main page (Vue 3 catalog); the theme head-script and the no-JS catalog block are injected by `tools/gen_pages.py`
...
- `robots.txt`, `sitemap.xml` — SEO (regenerated by `tools/verify.py` from the single `SITE_BASE`; indexes home page + all film pages)
