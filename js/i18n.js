const I18N = {
  ru: {
    ...
    startHere: "Рекомендую",
    startHereLead: "Моя подборка фильмов и сериалов.",
    results: "Найдено",
    resetFilters: "Сбросить фильтры",
    emptyQuery: "По этому запросу ничего не найдено.",
  ...
  en: {
    ...
    startHere: "My recommendations",
    startHereLead: "My selection of films and series.",
    results: "Found",
    resetFilters: "Reset filters",
    emptyQuery: "No titles match this search.",
